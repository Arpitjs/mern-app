...
const Nav = () => {
    ...
    return (
        <nav className="nav bg-dark d-flex justify-content-end">
            <Link href="/" ><a className={`nav-link text-light ${current === '/' && 'active'}`}>Home</a></Link>
              ...
              role="button" 
                ...
                <ul className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <Link href="/user/dashboard"><a
                        ...
                        <li>
                    <Link href="/user/profile/update"><a
                ...
                :
                <>
                    <Link href="/Login"><a className={`nav-link text-light ${current === '/Login' && 'active'}`}>Login</a></Link>

                    <Link href="/Register"><a className={`nav-link text-light ${current === '/Register' && 'active'}`}>Register</a></Link>
                </>
            }
        </nav>
